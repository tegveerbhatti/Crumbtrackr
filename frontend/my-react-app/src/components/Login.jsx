          ...
          <div className="max-w-md w-full bg-white p-8 border border-gray-300 rounded-lg shadow-md">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                ...
                <input type="password" name="password" value={password} onChange={handleChange('password')} id="password" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Enter your password" />
              </div>
            ...
            <p className="mt-6 text-center text-sm text-gray-600">
              Not registered yet? <a href="/register" className="font-medium text-indigo-600 hover:text-indigo-500">Create an account</a>
            </p>
          </div>
        </div>
      );
